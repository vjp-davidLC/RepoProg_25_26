    ...
    public static void main(String[] args) {
        ...
        do {            
            ...
            switch (opcionUsuario) {
                case 1:
                    System.out.println("Inserte la clave para su cuenta --> ");
                    int clave = entrada.nextInt();
                    // creamos una subcuenta con la subclase
                    cuentaActual = new CuentaClave(clave);
                ...
                case 2:
                    ...
                    System.out.println("Ahora inserte la clave para su cuenta --> ");
                    clave = entrada.nextInt();
                    // se crea una SUBcuenta con la cantidad que haya insertado el usuario
                    cuentaActual = new CuentaClave(cantidadDeseadaUsuario, clave);
                    System.out.println("Cuenta creada con exito.");
